...
(function (exports) {
    ...
    exports.initialize = function (defaultEventHandlers) {
        ...
        $('#readers-card').val(GlobalVariables.settings.user.readers_card);
        $('#organization').val(GlobalVariables.settings.user.organization);
        $('#user').val(GlobalVariables.settings.user.user);
        $('#questions').val(GlobalVariables.settings.user.questions);
        $('#reservation').val(GlobalVariables.settings.user.reservation);
        ...
        $('#select-servicemode').val(GlobalVariables.settings.user.select_servicemode);
        $('#select-servicemodeoptions').val(GlobalVariables.settings.user.select_servicemodeoptions);
